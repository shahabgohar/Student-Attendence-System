...
function approveApplication(id) {
  axios.post(appUrl + "/admin/approve/application", {
    id: id
...
function disapproveApplication(id) {
  axios.post(appUrl + "/admin/disapprove/application", {
    id: id
  }).then(function (response) {
    alert("disapproved");
    console.log(response);
...
function launchLeave(id) {
  ...
  axios.get(appUrl + "/admin/attendences/leave/application/".concat(id)).then(function (response) {
...
function getDataFromServer() {
  axios.get(appUrl + "/admin/attendences/for/approval").then(function (response) {
